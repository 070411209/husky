...
int main(int argc, char **argv)
{
    ...
    ros::Publisher chatter_pub = n.advertise<geometry_msgs::PoseStamped>("/move_base_simple/goal", 10); //initialize /move_base_simple/goal
    ...
    while (ros::ok())
    {
        ...
        msg.pose.orientation = tf::createQuaternionMsgFromYaw(M_PI);
        ...
        std::cout << " " << std::endl; //add two more blank row so that we can see the message more clearly
